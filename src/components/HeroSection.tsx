...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-[#980A0A] opacity-90 z-0"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
             Ignite your passion,{' '}
              <span className="text-[#F1C149]">Illuminate your future!</span> 
            </h1>
          ...
          <div className="hidden lg:block relative w-full aspect-[3/2]">
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#FC9C00] rounded-full opacity-20"></div>
            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#DE8F4D] rounded-full opacity-20"></div>
            <Image
              src="https://i.pinimg.com/736x/16/45/fd/1645fdbab720d4e531b527c1d26b227e.jpg"
