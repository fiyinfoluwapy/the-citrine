  ...
  return (
    <div className="w-full bg-[#F8F8F8]">
      <div className="container mx-auto px-4 py-8">
        <button
          onClick={() => router.push(`/events/${slug}`)}
          className="flex items-center text-gray-600 hover:text-[#DE8F4D] mb-4 transition-colors"
        >
          ← Back to Event
        </button>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block mb-1 font-medium text-gray-700">
                School Name <span className="text-[#DE8F4D]">*</span>
              </label>
              <input
                id="schoolName"
                type="text"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#DE8F4D] focus:border-[#DE8F4D] text-gray-800 placeholder-gray-400"
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">
                Contact Email <span className="text-[#DE8F4D]">*</span>
              </label>
              <input
                id="contactEmail"
                type="email"
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">
                Contact Phone <span className="text-[#DE8F4D]">*</span>
              </label>
              <input
                id="contactPhone"
                type="tel"
